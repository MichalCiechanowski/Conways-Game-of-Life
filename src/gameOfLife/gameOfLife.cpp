...
char gameOfLife::check(int x, int y) {
  ...
  if ((x == 0) && (y == 0)) {
    ...
    if (x == 0) {
      if (board.at(0).at(y - 1) == 'X')
        sum++;
      if (board.at(0).at(y + 1) == 'X')
        sum++;
      if (board.at(1).at(y + 1) == 'X')
        sum++;
      if (board.at(1).at(y - 1) == 'X')
        sum++;
      if (board.at(1).at(y) == 'X')
        sum++;
    } else

        if (x == (size - 1)) {
      if (board.at(size - 1).at(y - 1) == 'X')
        sum++;
      if (board.at(size - 1).at(y + 1) == 'X')
        sum++;
      if (board.at(size - 2).at(y + 1) == 'X')
        sum++;
      if (board.at(size - 2).at(y - 1) == 'X')
        sum++;
      if (board.at(size - 2).at(y) == 'X')
        sum++;
    } else

        if (y == 0) {
      if (board.at(x - 1).at(0) == 'X')
        sum++;
      if (board.at(x + 1).at(0) == 'X')
        sum++;
      if (board.at(x + 1).at(1) == 'X')
        sum++;
      if (board.at(x - 1).at(1) == 'X')
        sum++;
      if (board.at(x).at(1) == 'X')
        sum++;
    } else

        if (y == (size - 1)) {
      if (board.at(x - 1).at(size - 1) == 'X')
        sum++;
      if (board.at(x + 1).at(size - 1) == 'X')
        sum++;
      if (board.at(x + 1).at(size - 2) == 'X')
        sum++;
      if (board.at(x - 1).at(size - 2) == 'X')
        sum++;
      if (board.at(x).at(size - 2) == 'X')
        sum++;
    } else
